...
public interface Interfaccia {
	...
	//public Collection<T> stampaOrari(E check); //Stampa gli Orari del Medico inserito in base all'ID, o al Nome, o all'anno di Laurea 
	...
	//public Collection<T> stampaAppuntamenti(E dataInizio, E dataFine); //Stampa gli appuntamenti su un certo intervallo, qui prima E era un int
